...
export default function FormSignUp() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <input type="text" placeholder="enter name..." {...register("Name", {required: true, maxLength: 80})} />
      <label htmlFor="email">
        Email:<span> * </span>
      </label>
      <input type="email" placeholder="name@example.com" {...register("Email", {required: true, pattern: /^\S+@\S+$/i})} />
      {/* <input type="password" placeholder="Password" {...register("Password", {required: "Password is required!", min: 8, pattern: /^(?=.*[0-9])(?=.*[A-Za-z]).{8,32}$/i})}/> */}
